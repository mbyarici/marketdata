...
veri= pd.read_csv('PTF.csv',encoding='utf-8-sig',sep=";", decimal=",",index_col=False)
...
if not filtered_data.empty:
    ...
    if not filtered_data.empty:
        ...
        fig.add_trace(go.Scatter(x=filtered_data['Tarih'], y=filtered_data['PTF'], name='PTF', marker_color='red', mode='lines+markers',yaxis="y2"))

        fig.update_layout(barmode='group', title="FBA-FBS-PTF", height=500, yaxis=dict(title=dict(text="MWh"),side="left"), 
    ...
    if not filtered_data.empty:
        fig.add_trace(go.Bar(x=filtered_data['Tarih'], y=filtered_data['FBA'], name='FBA'))
        fig.add_trace(go.Scatter(x=filtered_data['Tarih'], y=filtered_data['YTP'], name='YTP', marker_color='red', mode='lines+markers',yaxis="y2"))
    ...
    if not filtered_data.empty:
        ...
        fig.add_trace(go.Scatter(x=filtered_data['Tarih'], y=filtered_data['Ritm'], name='Ritm', marker_color='red', mode='lines+markers',yaxis="y2"))
